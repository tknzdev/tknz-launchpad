...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, children, variant = "default", ...props }, ref) => {
    ...
    const variantClasses = {
      default:
        "bg-transparent border-2 border-cyber-green-neon text-cyber-green-neon hover:bg-cyber-green-neon hover:text-cyber-black hover:shadow-neon",
      ...
      ghost:
        "bg-transparent border border-cyber-green-neon/50 text-cyber-green-neon/80 hover:border-cyber-green-neon hover:text-cyber-green-neon hover:shadow-cyber",
      danger:
        "bg-transparent border-2 border-cyber-red-neon text-cyber-red-neon hover:bg-cyber-red-neon hover:text-cyber-black hover:shadow-[0_0_20px_#ff073a]",
    };
