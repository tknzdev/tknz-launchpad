...
const BaseReadableNumber: React.FC<
  Omit<ReadableNumberProps, "animated" | "showDirection">
> = ({
  num,
  format,
  prefix,
...
const AnimatedReadableNumber: React.FC<
  Omit<ReadableNumberProps, "animated">
> = ({
  num,
  format,
  prefix,
...
export const ReadableNumber: React.FC<ReadableNumberProps> = memo(
  ({ animated, ...props }) => {
    if (!animated) {
