...
>(({ className, ...props }, ref) => (
  <table
    ref={ref}
    className={cn("sm w-full caption-bottom", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8 whitespace-nowrap px-1 text-left align-middle font-medium text-cyber-green-neon/70 sm:h-10 sm:px-2",
      className,
    )}
    {...props}
  />
...
const TableCell = React.memo(
  ...
  >(({ className, ...props }, ref) => (
    <td
      ...
      className={cn(
        "table-cell whitespace-nowrap px-1 align-middle sm:px-2",
        className,
      )}
      {...props}
    />
